...
#define HDD_1_VID  0x0951
#define HDD_1_PID  0x1666

#define HDD_2_VID  0x0bc2
#define HDD_2_PID  0xab24


#define USB_EP_IN                   0x047
#define USB_EP_OUT                  0x056
...
MODULE_LICENSE("GPL");
MODULE_AUTHOR("shubham tyagi <h20191400558@hyderabad.bits-pilani.ac.in> ");
MODULE DESCRIPTION(" USB DEVICE DETECT");
